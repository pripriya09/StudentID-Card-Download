...
// Update the handleSubmit function to use your backend API
const handleSubmit = async (e) => {
  ...
  try {
    const formDataToSubmit = formData.map((data) => {
      ...
      const { name, fatherName, phoneNumber, address, image } = data;
      return {
        name,
        fatherName,
        phoneNumber,
    ...
    const response = await axios.post("http://localhost:5000/register-passengers", {
