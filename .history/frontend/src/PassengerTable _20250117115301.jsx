...
const PassengerTable = () => {
  ...
  useEffect(() => {
    // Fetch all passengers from the backend
    axios
  ...
  const handleEdit = (id) => {
    // Logic to edit passenger details
    console.log(`Edit passenger with ID: ${id}`);
  };

  const handleCancel = (id) => {
    // Logic to delete/cancel a passenger
    axios
  ...
  const handleDownloadPDF = () => {
    // Logic to download all passenger details as a PDF
