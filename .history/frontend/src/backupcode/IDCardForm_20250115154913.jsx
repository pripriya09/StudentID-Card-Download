...
const Form = () => {
  ...
  return (
    <div className="maincontainer">
      ...
      <>
  {data.map((data, index) => (
    <table key={index} border="1" style={{ margin: "10px auto", width: "80%", borderCollapse: "collapse" }}>
      <tbody>
        <tr>
          <td style={{ color: "red", fontWeight: "700", textAlign: "center", fontSize: "10px" }}>
        ...
        <tr>
          <td colSpan="3" style={{ textAlign: "center", color: "rgb(255, 0, 0)", fontWeight: "900", fontSize: "26px", filter: "drop-shadow(2px 1px 1px rgb(255, 230, 7))" }}>
        ...
        <tr>
          ...
          <td colSpan="2" style={{ color: "rgb(0, 0, 0)", fontWeight: "600", borderBottom: "dotted 1px rgb(58, 58, 58)", paddingLeft: "10px" }}>
        ...
        <tr>
          <td colSpan="2" style={{ color: "rgb(0, 0, 0)", fontWeight: "600", borderBottom: "dotted 1px rgb(58, 58, 58)", paddingLeft: "10px" }}>
            मोबाईल नं. - {data.phoneNumber}
          </td>
        </tr>
        <tr>
          <td colSpan="2" style={{ color: "rgb(0, 0, 0)", fontWeight: "600", paddingLeft: "10px" }}>
