  ...
  return (
    <div className="maincontainer">
      <div className="App">
        ...
        <label>Any kind of disease, if yes then give details
          <input type="text"
      ...
      <label> 
      Reference by (Name and Mobile Number) <input
  type="text"
  name="reference"
  placeholder="Reference by (Name and Mobile Number)"
  value={formData[index].reference || ""}
