  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Set idCardData only after successful registration
                ...
                <tr key={index}>
                  ...
                  <td>
                    <input
                      ...
                      onChange={(e) => handleChange(index, e)}
                         pattern="\d{10}"
                  title="Phone number must be 10 digits /only number allow"
                      required
                    />
                  </td>
                  <td>
          ...
          >
            <tbody>
              ...
              <tr>
                ...
                >
                  ए बी 468, दूसरी मंजिल, निर्माण नगर, किंग्स रोड़, अजमेर रोड़,
                  जयपुर मो- 8905902495
                </td>
              </tr>
              <tr>
