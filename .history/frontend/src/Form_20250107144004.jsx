  ...
  const handleDownloadPDF = () => {
    if (studentData) {
      ...
      html2canvas(captureElement).then((canvas) => {
        ...
        PDFdocument.addImage(imageData, "PNG", 10, 10, 180, 250);  // Adjust dimensions as necessary

        // Optionally add text information as well if needed, or remove if only the image is needed
        const studentInfo = `
          Student ID Card
