...
const Form = () => {
  ...
  const [previewImage, setPreviewImage] = useState(null); // To store preview of uploaded image
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send form data to the server (this could be changed to your API endpoint)
        ...
        <div className="left">
          <div className="circle">
            <img
              ...
              src={previewImage || "https://via.placeholder.com/150"} // Default demo image
              alt="Student"
            />
          </div>
        </div>
