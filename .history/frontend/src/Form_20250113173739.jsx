...
const Form = () => {
  ...
  const [showConsent, setShowConsent] = useState(false); // State to control showing the consent checkbox
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setShowConsent(false); // Hide consent after submission
    ...
    <div className="maincontainer">
      ...
      <div className="App">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Show consent before submission */}
          {showConsent && (
  ...
  <table className="id-card-table"
   key={index} style={{ width: '100%', borderCollapse: 'collapse',margin:'20px auto' }}>
    <tbody >
      <tr >
        <td
          style={{
