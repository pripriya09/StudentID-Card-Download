  ...
  <div className="top_section">
    ...
    <div className="student_name">
      <ul className="student_info">
        ...
        <li className="age">
          <span className="bold">Age: 20</span> {/* Replace with actual data if available */}
        </li>
      </ul>
    </div>
  </div>
  ...
  <div className="bottom_section">
    <div className="student_details">
      <ul>
        ...
        <li>
          <span className="bold">Course:</span> Full Stack Software
          Development {/* Replace with actual data if available */}
        </li>
        <li>
          <span className="bold">Class:</span> Bootcamp
        </li>
      </ul>
    </div>
  </div>
