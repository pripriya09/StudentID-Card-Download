...
const Form = () => {
  ...
  // Handle PDF download (including image and text as part of the card)const handleDownloadPDF = () => {
  if (studentData) {
    ...
    if (profileImage) {
      PDFdocument.addImage(profileImage, "PNG", 10, 10, 40, 40); // (x, y, width, height)
    }
    ...
    PDFdocument.text(studentInfo, 60, 10); // (x, y) for text position
