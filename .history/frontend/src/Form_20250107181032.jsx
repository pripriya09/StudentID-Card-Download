  ...
  return (
    <div className="App">
      <form onSubmit={handleSubmit}>
        ...
        {/* Dynamically render ID card fields based on passenger count */}
        {[...Array(passengerCount)].map((_, index) => (
          <div key={index} className="passenger-id-card">
            <input
              type="text"
            ...
            <input
              type="text"
              name={`passengerId-${index}`}
              placeholder={`Passenger ${index + 1} ID`}
              required
            />
          </div>
        ))}
