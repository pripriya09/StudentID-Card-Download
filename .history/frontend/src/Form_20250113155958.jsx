  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
       ...
       const alldata = setFormData((prevData) =>
  ...
  return (
    <div className="maincontainer">
      <div className="App">
        ...
        {idCardData && idCardData.map((IDdata, index) => (
          <>
            {" "}
            ...
            <div key={index} className="student_id">
              <div className="top_section">
                ...
                <div className="student_name">
                  ...
                  <p>Name - {IDdata.name}</p>
                  <p>Father's Name - {IDdata.fatherName}</p>
                  <p>Phone Number - {IDdata.phoneNumber}</p>
                  <p>Address - {IDdata.address}</p>
                  <p>Reg. No. - {IDdata.registrationNumber}</p>
                </div>
              </div>
            </div>
          </>
