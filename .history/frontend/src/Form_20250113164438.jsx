  ...
  return (
    <div className="maincontainer">
      ...
      <tbody>
        ...
        <tr>
            <td colspan="3" class="large-text" style="color: rgb(0, 0, 0); font-weight: 600;border-bottom: dotted 1px rgb(58, 58, 58);">पदयात्री का नाम - Pradeep Kumar</td>
        </tr>
        <tr>
            <td colspan="3" class="large-text" style="color: rgb(0, 0, 0); font-weight: 600;border-bottom: dotted 1px rgb(58, 58, 58);">मोबाईल नं. - +91 1234567890</td>
        </tr>
        <tr>
