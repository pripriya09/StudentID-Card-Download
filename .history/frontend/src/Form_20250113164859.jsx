...
const Form = () => {
  ...
  return (
    <div className="maincontainer">
      ...
      <tbody>
        <tr>
            <td  style="color:red; font-weight: 700;text-align: center;font-size: 10px;float: inline-start;">॥ श्री खाटू श्याम देवाय नमः ॥</td>
            <td colspan="2" class="center-text" style="color: rgb(0, 0, 206); font-weight: 700;font-size: 10px; float: inline-end;">रजि. नं. : COOPI2024 / JAIPURI206591</td>
        </tr>
     
        <tr>
            <td colspan="3" class="center-text" style="color: rgb(255, 0, 0); font-weight: 900; font-size: 26px; filter: drop-shadow(2px 1px 1px rgb(255, 230, 7));">श्री खाटू श्याम सेवादार समिति</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" class="center-text" style="color: rgb(255, 0, 43); font-weight: 700; font-size: 15px;text-align: center; ">
                रींगस से खाटूधाम पदयात्रा (दिनांक- 13 फरवरी 2025)
            </td>
        </tr>
   
        <tr>
            <td colspan="3" class="large-text" style="color: rgb(0, 0, 0); font-weight: 600;border-bottom: dotted 1px rgb(58, 58, 58);">रजिस्ट्रेशन नं. -{data.registrationNumber}</td>
        </tr>
        <tr>
            <td colspan="3" class="large-text" style="color: rgb(0, 0, 0); font-weight: 600;border-bottom: dotted 1px rgb(58, 58, 58);">पदयात्री का नाम -{data.name}</td>
        </tr>
        <tr>
            <td colspan="3" class="large-text" style="color: rgb(0, 0, 0); font-weight: 600;border-bottom: dotted 1px rgb(58, 58, 58);">पदयात्री का नाम -{data.fatherName}</td>
        </tr>
        <tr>
            <td colspan="3" class="large-text" style="color: rgb(0, 0, 0); font-weight: 600;border-bottom: dotted 1px rgb(58, 58, 58);">मोबाईल नं. - +91:{data.phoneNumber}</td>
        </tr>
        <tr>
            <td colspan="3" class="large-text" style="color: rgb(0, 0, 0); font-weight: 600;">पदयात्री का पता -
            {data.address}</td>
        </tr>
   
        <tr>
            <td colspan="3" class="center-text" style="color: rgb(12, 0, 177); font-weight: 700; font-size: 13px;border-top: solid 2px black;">
