...
const handleSubmit = async (e) => {
  ...
  try {
    const formDataToSubmit = formData.map((data) => {
      ...
      const { name, fatherName, phoneNumber, address, image, consent } = data;
      return {
        name,
        fatherName,
        phoneNumber,
