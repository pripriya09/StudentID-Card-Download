  ...
  const handleDownloadPDF = () => {
    ...
    if (idCardElement) {
      html2canvas(idCardElement, { scale: 1 }).then((canvas) => {
        ...
        const fixedWidth = 180; // Set a fixed width for the ID card
        const fixedHeight = 180; // Set a fixed height for the ID card
        ...
        // Add the image to the PDF using the fixed size for the ID card
        pdf.addImage(imgData, "PNG", 0, 0, adjustedWidth, fixedHeight);
