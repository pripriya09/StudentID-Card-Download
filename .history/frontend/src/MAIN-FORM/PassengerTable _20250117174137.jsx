...
const PassengerTable = () => {
  ...
  const handleDownloadPDF = (passengerId) => {
    ...
    idCard.style.width = "100px";  // Set a specific width for the card
    idCard.style.height = "60px"; // Set a specific height for the card
  
    idCard.innerHTML = `
      <table class="id-card-table" style="width: 100%; height: 100%;">
        <tbody>
          <tr>
          ...
          <tr>
            <td colSpan="3" style="text-align: center; color: rgb(255, 0, 0); font-weight: 900; font-size: 18px;">
          ...
          <tr>
            <td colSpan="3" style="text-align: center; color: rgb(255, 0, 43); font-weight: 700; font-size: 13px;">
              रींगस से खाटूधाम पदयात्रा (दिनांक- 13 फरवरी 2025)
            </td>
          </tr>
          <tr>
            <td colSpan="1" rowSpan="5" style="text-align: center;">
              <img src="${passenger.image}" class="profile-img" alt="Profile" style="width: 70px; height: 70px; border-radius: 50%;" />
            </td>
