...
const PassengerTable = () => {
  ...
  const handleEdit = (passengerId) => {
    ...
    setEditablePassenger(passengerToEdit); // Set the editable passenger
  };

  const handleCancel = () => {
    setEditablePassenger(null); // Reset the editable state
  };

  const handleChange = (e) => {
    if (editablePassenger) {
      setEditablePassenger({
        ...editablePassenger,
  ...
  const handleSave = () => {
    // Implement saving the changes, e.g., via API call
    setEditablePassenger(null);
  };
            ...
            passengers.map((passenger) => (
              <React.Fragment key={passenger._id}>
                <tr>
                  ...
                  <td>
                    <button onClick={() => handleDownloadPDF(passenger)}>
                      Download PDF
                    </button>
                  </td>
                </tr>
