...
const PassengerTable = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    // if (passengers.some((data) => !data.registrationNumber)) {
  ...
  return (
    <div>
      ...
      <table className="id-card-table" key={passenger._id}>
  <tbody>
    {/* First Row */}
    <tr>
      <td
    ...
    <tr>
      ...
      >
        ए बी 468, दूसरी मंजिल, निर्माण नगर, किंग्स रोड़, अजमेर रोड़, जयपुर मो-
        8905902495
      </td>
    </tr>
    ...
    <tr>
      ...
      >
        सम्पर्क सूत्र : 8696555530, 9887662860, 9828156963, 6376999432,
        9314476414, 9828256321, 9782676365
      </td>
    </tr>
  </tbody>
</table>;
