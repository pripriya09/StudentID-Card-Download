...
const Form = () => {
  ...
  const [studentData, setStudentData] = useState(null); // Holds the student data
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Fetch student data with the registration number
        ...
        <div className="id-card">
          <div className="left">
            {studentData.image && (
              <div>
                <img
                  src={`data:image/jpeg;base64,${studentData.image}`} // Display the image using base64
                  alt="Student"
