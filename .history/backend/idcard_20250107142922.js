...
import path from 'path'; // Optional, used for path management
...
app.use(cors({
  origin: [
    "http://localhost:5174", // Adjust to your frontend port
    "http://localhost:5173",
    "http://127.0.0.1:5173",
  ]
}));
...
// POST endpoint to save student data (including Base64 image)
...
// GET endpoint to fetch student data
